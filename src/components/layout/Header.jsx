...
function Header({ placement, onPress, handleSidenavColor, handleSidenavType, handleFixedNavbar }) {
  ...
  return (
    <>
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={8}>
          <div>Welcome Ganeshop Admin</div>
        </Col>
        <Col span={24} md={16} className="header-control">
          ...
          {/* <Drawer className="settings-drawer" mask={true} width={360} onClose={hideDrawer} placement={placement} open={visible}>
            <div layout="vertical">
          ...
          <Button className="btn-sign-in" type="text" onClick={() => navigate('/login', { replace: true })}>
            <LogoutOutlined />
            <span>Sign Out</span>
          </Button>
        </Col>
